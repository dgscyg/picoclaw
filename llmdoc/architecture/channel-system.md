...
- `pkg/channels/wecom/official.go`, `app.go`, `aibot.go`: WeCom variants for official accounts, apps, and AI bots.
...
Per-channel rate limits configured in `channelRateConfig`: telegram (20/s), discord (1/s), slack (1/s), matrix (2/s), line (10/s), irc (2/s).
