...
- `pkg/tools/result.go` (`ToolResult`, `NewToolResult`, `SilentResult`, `AsyncResult`, `ErrorResult`, `UserResult`): Structured result types with dual-output support (ForLLM/ForUser).
